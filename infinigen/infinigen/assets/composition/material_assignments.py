...
def add_clear(materials_list):
    all_probabilities = sum([prob for _, prob in materials_list])
    return materials_list + [
        (ceramic.Glass, all_probabilities / 1.2),
        ((plastic.PlasticTranslucent, all_probabilities / 3)),
    ]
