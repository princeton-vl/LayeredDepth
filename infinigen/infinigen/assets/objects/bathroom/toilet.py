...
class ToiletFactory(AssetFactory):
    def __init__(self, factory_seed, coarse=False):
        ...
        with FixedSeed(self.factory_seed):
            ...
            clear_surface_gen_class = weighted_sample(
                material_assignments.add_clear(material_assignments.ceramics)
            )
            self.clear_surface = clear_surface_gen_class()
    ...
    def create_asset(self, **params) -> bpy.types.Object:
        ...
        write_attribute(seat, 1, "clearable", "FACE")
        write_attribute(cover, 1, "clearable", "FACE")
    ...
    def finalize_assets(self, assets):
        ...
        self.clear_surface.apply(assets, "clearable")
        if self.scratch:
