...
class StraightStaircaseFactory(AssetFactory):
    ...
    def __init__(self, factory_seed, coarse=False, constants=None):
        ...
        with FixedSeed(self.factory_seed):
            ...
            self.step_surface = weighted_sample(
                material_assignments.add_clear(material_assignments.step)
            )()
            ...
            self.rail_surface = weighted_sample(
                material_assignments.add_clear(material_assignments.rail)
            )()
            ...
            self.tread_surface = weighted_sample(
                material_assignments.add_clear(material_assignments.tread)
            )()
            ...
            self.side_surface = weighted_sample(
                material_assignments.add_clear(material_assignments.side)
            )()
