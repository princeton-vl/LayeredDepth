...
class KitchenCabinetBaseFactory(AssetFactory):
    ...
    def get_material_params(self):
        with FixedSeed(self.factory_seed):
            ...
            params["frame_material"] = np.random.choice(
                ["white", "black_wood", "wood", "glass"], p=[0.2, 0.1, 0.2, 0.5]
            )
    ...
    def get_material_func(self, params, randomness=True):
        with FixedSeed(self.factory_seed):
            ...
            elif params["frame_material"] == "glass":
                params["frame_material"] = surface.shaderfunc_to_material(shader_glass)
            ...
            elif params["board_material"] == "glass":
                params["board_material"] = surface.shaderfunc_to_material(shader_glass)
