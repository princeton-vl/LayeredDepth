...
from infinigen.assets.composition.material_assignments import add_clear
from infinigen.assets.lighting.extreme_lights import DiscoLightFactory
...
class LampFactory(AssetFactory):
    def __init__(
        ...
        if U() < 0.7:
            ...
            self.bulb_fac = DiscoLightFactory(factory_seed)
            self.bulb_fac.params["Wattage"] *= 0.5
        ...
        self.lampshade_material = weighted_sample(
            add_clear(material_assignments.lampshade)
        )
    ...
    def get_material_params(self):
        ...
        lampshade_material = np.random.choice([shader_lampshade, shader_glass])
