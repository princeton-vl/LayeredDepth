...
if __name__ == "__main__":
    ...
    parser.add_argument("--method_name", help="Method name that will be displayed in the leaderboard", default='dummy')
    parser.add_argument("--benchmark", help="Benchmark name that will be displayed in the leaderboard", default='first_layer', choices=['first_layer', 'multi_layer'])
